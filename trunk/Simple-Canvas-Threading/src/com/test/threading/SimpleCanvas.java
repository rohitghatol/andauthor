...
import com.test.threading.reader.DocumentReadListener;
import com.test.threading.reader.DocumentReader;
...
public class SimpleCanvas extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final DocumentReader reader = new DocumentReader(canvasView,new DocumentReadListener() {
